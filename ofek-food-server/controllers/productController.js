...
const orderBySSLCommerz = async (req, res) => {
  try {
    ...
    const data = {
      ...
      success_url: 'https://food-u-mern.netlify.app/api/v1/product/success',
      fail_url: 'https://food-u-mern.netlify.app/api/v1/product/fail',
      cancel_url: 'https://food-u-mern.netlify.app/api/v1/product/cancel',
      ipn_url: 'https://food-u-mern.netlify.app/ipn',
